...
![PhishGuard AI](https://img.shields.io/badge/Security-PhishGuard%20AI-00d4aa?style=for-the-badge&logo=shield)
![Spring Boot](https://img.shields.io/badge/Spring_Boot-3.1.0-6DB33F?style=for-the-badge&logo=spring)
![React](https://img.shields.io/badge/React-18-61DAFB?style=for-the-badge&logo=react)
![PostgreSQL](https://img.shields.io/badge/Neon_DB-PostgreSQL-336791?style=for-the-badge&logo=postgresql)

PhishGuard AI is an enterprise-grade, full-stack threat intelligence platform designed to detect and prevent phishing attacks, malicious URLs, and social engineering email scams in real-time. 

Built with a robust **Spring Boot** backend and a sleek, dynamic **React (Vite)** frontend, the application integrates industry-leading APIs like **VirusTotal** and **Google Safe Browsing** for highly accurate threat detection.
...
- **☁️ Cloud-Native Database:** Fully integrated with Serverless Neon DB (PostgreSQL) for scalable, reliable data persistence.
...
- **Vanilla CSS + CSS Variables** (Custom Design System, Glassmorphism UI)
...
```bash
git clone https://github.com/SaurabhBiswal/MEGA-PROJECT-16-Java---AI-Phishing-Detection-Platform.git
cd MEGA-PROJECT-16-Java---AI-Phishing-Detection-Platform
```
...
Passionate about building scalable, secure, and visually stunning web applications.

---

*This project was built as part of an advanced full-stack development portfolio.*
