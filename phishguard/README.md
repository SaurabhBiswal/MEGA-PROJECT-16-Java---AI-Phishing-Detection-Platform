# 🛡️ PhishGuard AI — Frontend

**AI Phishing Detection Platform** built with React 18, TypeScript, Vite, and Axios.  
Designed to integrate with a Java Spring Boot + PostgreSQL backend via REST APIs and JWT authentication.
